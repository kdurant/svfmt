...
begin
    ...
    else if(mii_select && !mii_odd_reg)
    begin
    ...
    begin
        ...
        case(state_reg)
            ...
            begin
                ...
                if(gmii_rx_dv_d0_reg)
                begin
                    if(gmii_rx_er_d0_reg)
                    begin
                        // error in preamble
                        in_pre_next              = 1'b0;
                        pre_ok_next              = 1'b0;
                    ...
                    else if(gmii_rxd_d0_reg == ETH_PRE)
                    begin
                        // normal preamble
                    end
                    else if(gmii_rxd_d0_reg == ETH_SFD)
                    begin
                        // start
                        in_pre_next = 1'b0;
                        if(in_pre_reg && cfg_rx_enable)
                        begin
            ...
            begin
                ...
                if(gmii_rx_dv_d4_reg && !gmii_rx_er_d4_reg && gmii_rxd_d4_reg == ETH_SFD)
                begin
...
begin
    ...
    begin
        ...
        begin
            ...
            else if(gmii_rx_dv && gmii_rxd == ETH_SFD)
            begin
                in_frame_reg         <= 1'b1;
                start_packet_int_reg <= 1'b1;
            end
